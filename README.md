...
Backend developer and IT student specializing in backend systems, event-driven pipelines, and local AI agent workflows. Hands-on experience with FastAPI, Python architectures, and custom RAG implementations. Focused on developer tooling, scalable backend systems, and secure API design.

---

## Experience

**Data / Python Intern — NSP Nexus**
*Jun 2025 – Jul 2025 · Python, Scikit-Learn, Pandas, NumPy*
- Built KNN and Logistic Regression models achieving 100% accuracy on benchmark evaluation sets
- Designed a rule-based AI chatbot backend with structured conditional routing

**Cyber Security Intern — SkillForge**
*Jun 2025 – Jul 2025 · Kali Linux, Nmap, Ophcrack, Social Engineering*
- Identified a critical MS17-010 (EternalBlue) SMB vulnerability via Nmap scans
- Simulated phishing/credential-harvesting scenarios; recovered weak credentials with Ophcrack
